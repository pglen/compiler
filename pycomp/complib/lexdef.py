...
try:
    ...
    (INI_STATE, "in"   ,    "int"           , STATE_NOCH, ),
    (INI_STATE, "lon"  ,    "long"          , STATE_NOCH, ),
    (INI_STATE, "ucha" ,    "uchar"         , STATE_NOCH, ),
    (INI_STATE, "ushort",   "ushort"       , STATE_NOCH, ),
    (INI_STATE, "uin"  ,    "uint"          , STATE_NOCH, ),
    (INI_STATE, "ulon" ,    "ulong"         , STATE_NOCH, ),
    (INI_STATE, "S"    ,    "S8"            , STATE_NOCH, ),
    (INI_STATE, "S1"   ,    "S16"           , STATE_NOCH, ),
    (INI_STATE, "S3"   ,    "S32"           , STATE_NOCH, ),
    (INI_STATE, "S6"   ,    "S64"           , STATE_NOCH, ),
    (INI_STATE, "S12"  ,    "S128"          , STATE_NOCH, ),
    (INI_STATE, "U"    ,    "U8"            , STATE_NOCH, ),
    (INI_STATE, "U1"   ,    "U16"           , STATE_NOCH, ),
    (INI_STATE, "U3"   ,    "U32"           , STATE_NOCH, ),
    (INI_STATE, "U6"   ,    "U64"           , STATE_NOCH, ),
    (INI_STATE, "U12"  ,    "U128"          , STATE_NOCH, ),
    ...
    (INI_STATE, "paren",    "\("             ,  STATE_NOCH, ),
    (INI_STATE, "paren2",   "\)"             , STATE_NOCH, ),
    (INI_STATE, "under",    "_"              ,  STATE_NOCH, ),
    (INI_STATE, "eq",       "="              , STATE_NOCH, ),
    (INI_STATE, "lt",       "<"              , STATE_NOCH, ),
    (INI_STATE, "gt",       ">"              , STATE_NOCH, ),
    (INI_STATE, "and",      "&"              , STATE_NOCH, ),
    (INI_STATE, "star",     "\*"             ,  STATE_NOCH, ),
    (INI_STATE, "plus",     "\+"             ,  STATE_NOCH, ),
    (INI_STATE, "caret",    "\^"             ,  STATE_NOCH, ),
    (INI_STATE, "perc",     "%"              ,  STATE_NOCH, ),
    (INI_STATE, "div",      "/"              , STATE_NOCH, ),
    (INI_STATE, "sp",       " "              , STATE_NOCH, ),

    (INI_STATE, "nl",       "\n"             , STATE_NOCH, ),
    (INI_STATE, "lbrack",   "\)"             , STATE_NOCH, ),
    (INI_STATE, "rbrack",   "\]"             , STATE_NOCH, ),
    (INI_STATE, "lbrace",   "\("             , STATE_NOCH, ),
    (INI_STATE, "rbrace",   "\)"             , STATE_NOCH, ),
    (INI_STATE, "lcurl",    "\{"             ,  STATE_NOCH, ),
    (INI_STATE, "rcurl",    "\}"             ,  STATE_NOCH, ),
    (INI_STATE, "comma",    ","              ,  STATE_NOCH, ),
    (INI_STATE, "colon",    ";"              ,  STATE_NOCH, ),
    (INI_STATE, "scolon",   ":"              , STATE_NOCH, ),
    # Fallback here
