...
<INITIAL,EMITSTATE>\n                              {
                                if(config.testpreflex)
                                    { printf(" [NL2] '%d' ", yytext[0]); fflush(stdout); }
