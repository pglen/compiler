...
static YYACTIONTYPE yy_action[] = {
 /*     0 */     7,    5,   11,    9,   17,   24,    1,   14,    4,   11,
 /*    10 */     9,   13,    2,   13,    3,   24,    6,   24,    8,   10,
 /*    20 */    12,
};
static YYCODETYPE yy_lookahead[] = {
 /*     0 */     1,    2,    3,    4,    5,   10,   11,    0,    8,    3,
 /*    10 */     4,    6,   12,    6,    5,   13,    8,   13,    8,    8,
 /*    20 */     8,
};
#define YY_SHIFT_USE_DFLT (-2)
static signed char yy_shift_ofst[] = {
 /*     0 */    -2,    7,    9,   -2,   -1,    5,    6,    5,    6,    5,
 /*    10 */    -2,    5,   -2,   -2,
};
#define YY_REDUCE_USE_DFLT (-6)
static signed char yy_reduce_ofst[] = {
 /*     0 */    -5,    0,   -6,   -6,   -6,    8,   -6,   10,   -6,   11,
 /*    10 */    -6,   12,   -6,   -6,
};
static YYACTIONTYPE yy_default[] = {
 /*     0 */    15,   23,   23,   16,   23,   23,   18,   23,   19,   23,
 /*    10 */    20,   23,   21,   22,
};
...
static void yy_reduce(
  ...
  */
      ...
      case 2:
        /* No destructor defined for in */
        /* No destructor defined for state */
  yy_destructor(5,&yymsp[0].minor);
        break;
      case 3:
#line 66 "example5.y"
{
                        std::cout << "Result.value=" << yymsp[0].minor.yy20.value << std::endl;
                        std::cout << "Result.n=" << yymsp[0].minor.yy20.n << std::endl;
...
#line 582 "example5.c"
      ...
      case 4:
#line 74 "example5.y"
{ yygotominor.yy20.value = yymsp[-2].minor.yy20.value - yymsp[0].minor.yy20.value;
                                       yygotominor.yy20.n = yymsp[-2].minor.yy20.n+1  + yymsp[0].minor.yy20.n+1;
                                      }
#line 589 "example5.c"
...
#line 620 "example5.c"
  yy_destructor(3,&yymsp[-1].minor);
      ...
      case 8:
#line 95 "example5.y"
{ yygotominor.yy20.value = yymsp[0].minor.yy0.value; yygotominor.yy20.n = yymsp[0].minor.yy0.n+1; }
#line 626 "example5.c"
        break;
  };
